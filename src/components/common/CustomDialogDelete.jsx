    ...
    <Dialog open={open} onClose={() => setOpen(!open)}>
      <DialogTitle>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            >
              <DeleteIcon sx={{ fontSize: '20px', color: '#F33A3A' }} />{' '}
            </Box>
      ...
      <DialogContent sx={{ minWidth: '156px', maxWidth: '300px' }}>
        <Typography sx={{ fontSize: '14px' }}>
          Are you sure you will delete the data {dataToDelete} ?
        </Typography>
        ...
        >
          <Typography
            sx={{ color: '#9E9D9D', cursor: 'pointer', fontSize: '14px' }}
            onClick={() => setOpen(!open)}
          >
            Cancle
          </Typography>
